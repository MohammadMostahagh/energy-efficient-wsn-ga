...
def plot_scientific_results():
    ...
    # ==========================================
    # نمودار 1: روند رشد فیتنس (ماکزیمم و متوسط)
    # ==========================================
    ...
    # ==========================================
    # نمودار 2: تنوع ژنتیکی جمعیت (Diversity)
    # ==========================================
    plt.figure(figsize=(8, 6))
    ...
    # ==========================================
    # نمودار 3: بهینه‌سازی مصرف انرژی
    # ==========================================
    plt.figure(figsize=(8, 6))
    ...
    # ==========================================
    # نمودار 4: بهینه‌سازی تأخیر مسیر (Hops)
    # ==========================================
    plt.figure(figsize=(8, 6))
    ...
    # ==========================================
    # نمودار 5: توازن بار و انرژی باقیمانده گلوگاه
    # ==========================================
    plt.figure(figsize=(8, 6))
